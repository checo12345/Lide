...
<script src="js/actualizarProducto.js" charset="UTF-8"></script>
<%@ taglib prefix="s" uri="/struts-tags"%>


<h1 class="m-t-none m-b" style="text-align: center;" id="tituloForm">Actualizar Productos</h1>
<form id="buscarProductoForm" class="form-horizontal" action="agregarProducto" role="form" onsubmit="return false;" style="min-height: 70px;">
	...
	<label class="control-label">Acciones</label>
		<div class="input-group">
			<button onclick="obtenerProductoPorNombre()" type="button" class="btn btn-primary block m-b pull-right"  data-toggle="modal" data-target="#myModal"> Buscar Producto</button>
		</div>
